...
local function OnLeave( self )
	if self.itemPlayer then
		Me.playerItemTooltipOpen = false
		if DiceMasterCursorItemIcon.editCursor or DiceMasterCursorItemIcon.sellCursor or DiceMasterCursorItemIcon.chooseCursor or DiceMasterCursorItemIcon.requestCursor or DiceMasterCursorItemIcon.lootCursor then
